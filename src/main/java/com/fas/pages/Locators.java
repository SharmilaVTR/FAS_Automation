...
public class Locators  extends BaseTest {
	//Locators of ui spy application


	//Resuable Xpath

	public static String  Ok_Name="OK";
	public static String  AcctDate_Name="Acct Date Row 0";

	public static String  btnDetailDelete_Name="btnDetailDelete";
	public static String  Close_Name="Close (Alt -X)";
	...
	public static String  ATBrowser_Name="A/T";
	public static String  AssetSortName_Name="Asset Sort Name Row 0";

	public static String  btnDetailClose_Id="btnDetailClose";
	...
	public static String  RBrowser_Name="R";
	public static String  DepositTo_Name="Deposit To";
	public static String  EntryRow0_Name="Entry Type Row 0";
	public static String  CBrowser_Name="C";
	public static String  LongTerm_ID="rdoLongTerm";
	public static String  PBrowser_Name="P";

	public static String  AddAssetDropdown_ID="cmbAsset";
	public static String  PrincipalRadioButton_ID="rdoPrincipal";
	public static String  STBrowser_Name="St";
	public static String  SPBrowser_Name="Sp";
